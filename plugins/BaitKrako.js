$.plugin({
    ...
    TalkBot: function(msg, tags, nick) {
		...
		var HunieArray = ["Nan mais je joue pas que pour le plot, les phases candy crush sont vraiment intéressantes","Faudrait que je m'y remette, j'ai pas encore 100%, j'ai pas acheté tous les cadeaux aux gonzesses","Quand meme, Momo a beau etre une chatte, elle est quand meme vachement mignonne"];
        if (msg.charAt(0) != '/' && msg.indexOf('plugin') === -1 && (!tags || (tags && nick))) {
			...
			if((msg.indexOf("HuniePop") > -1) || (msg.indexOf("Huniepop") > -1) ||(msg.indexOf("huniepop") > -1)||(msg.indexOf("huniePop") > -1))
				setTimeout(function(){
