var IRCcmd = function () {
    ...
    _cmdList = {
        ...
        ignore: { func: toggleIgnore, description:'Ignore totalement un user (de pr�f�rence dagoulas)', proto:'/ignore &lt;pseudo&gt;'},
        unignore: { func: toggleIgnore, description:'Desactive l\'ignore', proto:'/unignore &lt;pseudo&gt;'},
        leave: { func: logout, description:'Se d�connecte du chat', proto:'/logout ou /leave'},
        logout: { func: logout },
        ...
        saywho: { func: saywho },
        mp : { func: mp, description:'Envoie un message priv�', proto:'(/w|/mp|/notice) &lt;pseudo&gt; [message]'},
